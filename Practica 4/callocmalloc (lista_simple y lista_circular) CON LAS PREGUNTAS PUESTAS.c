...
//Lo intente al hacer pruebas y testeos con mi programa y tecnicamente no paso nada.. igaul me dio miedo.. pero se supone que la memoria no se libera el programa consume cada vez más RAM si se repite muchas veces, mi sistema se puede quedar sin memoria y crashear la PC
